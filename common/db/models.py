...
class Item(Base):
    ...
    manufacturer_item_description = Column(String, nullable=True)
    unit_qty = Column(String, nullable=True)
    quantity = Column(String, nullable=True)
    bIs_weighted = Column(String, nullable=True)
    unit_of_measure = Column(String, nullable=True)
    qty_in_package = Column(String, nullable=True)
    item_price = Column(String, nullable=False)
    unit_of_measure_price = Column(String, nullable=True)
    allow_discount = Column(String, nullable=True)
